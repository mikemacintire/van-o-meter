...
- `dashboard.py` + `web/index.html` — local console on :8642 (Overview / Units / Control / Power / Energy / System); Control view sends commands via `POST /api/control` with readback verification
